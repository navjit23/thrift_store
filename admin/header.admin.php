...
<!-- nav bar-->
<div id= "main_admin_nav" class="navbar navbar-expand-md navbar-dark orange ">

<div class="container">
<a href="../index.php" class="navbar-brand text-dark"><h2>MCC Thrift Store</h2></a>
<button class="navbar-toggler" data-bs-toggle="collapse"
        data-bs-target="#admin_nav">
...
<ul class="navbar-nav">
    ...
    <li class="nav-item"><a href="../scripts/logout.inc.php" class="nav-link text-white">Log Out</a></li>
    <li class="nav-item"><a href="admin.php" class="nav-link text-dark fw-bolder ">Admin !</a></li>
